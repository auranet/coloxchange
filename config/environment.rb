...
Rails::Initializer.run do |config|
  config.action_controller.session = {:session_key => "_coloxchange_session",:secret => "fad6b009ac5a89d8c2026b3db13f8ddbedd4d0ebe56e6bd030394688294aea6b6e7209ae3932c59f959a482fba38eab2ec6c1477fadb6c3db935a81bf908730d"}
